...
\[S_t > S_c \implies f_s = \frac{E_{rt}^2}{S_t + E_{rt}^2}\]
...
\[\frac{dX[A]}{dt}\]
diferansiyel denklemini besleyen modüle edilmiş üretim akışı (\(k_{\text{prod}}^{(t)}\)), hesaplanan sınırlama metrikleri kullanılarak zayıflatılır:
